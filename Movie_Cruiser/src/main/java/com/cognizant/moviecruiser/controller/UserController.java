...
public class UserController {
	...
	static List<MovieWithImage> movieList;
	
	@RequestMapping(value = {"/customer","/menu-item-list-customer"}, method = RequestMethod.GET)
	public String getMainPage(ModelMap model)
	{
	 listcust=movieDaoSqlImpl.getMovieListCustomer();
	 movieList = movieDaoSqlImpl.getWithImageOfMoviesList(listcust);

		model.put("inf", movieList);
	...
	public String getadminPage(ModelMap model)
	{
		...
		List<MovieWithImage> movieList = movieDaoSqlImpl.getWithImageOfMoviesList(list);
		model.put("inf", movieList);
