...
<body>
    ...
    Movie Cruiser</div>
       ...
       <div class="collapse navbar-collapse" id="collapsibleNavbar">  
            <ul class="navbar-nav active">
                ...
                <li class="nav-item">
                    <a class="nav-link" style="color: white;" href="showfavorite"><i class="material-icons" id="iconsize">favorite</i> Favourites</a>
                </li>
    ...
    <div class="container-fluid mt-3">
        ...
        <c:forEach items="${inf}" var="temp">
            <div class="col-sm-3">
                <div class="card">
                <img class="card-img-top img-fluid" data-bind="foreach:image"
							src="data:image/jpg;base64,${temp.image}"
							alt="no image found" style="height:250px; ">
                    <div class="card-body">
